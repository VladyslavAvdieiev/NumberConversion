...
namespace NumberConversion.Tests
{
    public class NumberConverterTests {
        ...
        [InlineData(37)]    // near the boundary
        [InlineData(42)]    // far from the boundary
        public void ConvertFractionPartToAnySystem_TryToConvertDataToInvalidNumberSystem_Should_ThrowIndexOutOfRangeException(int system) {
            /*Assert*/
            Assert.Throws<IndexOutOfRangeException>(() => NumberConverter.ConvertFractionPartToAnySystem(string.Empty, system));
        }
        ...
        [InlineData("11b22")]   // used char from alphabet is bigger than decimal number system
        [InlineData("1C113")]   // used char from alphabet is bigger than decimal number system
        public void ConvertFractionPartToAnySystem_TryToConvertInvalidNumber_Should_ThrowArgumentException(string number) {
            /*Assert*/
            Assert.Throws<ArgumentException>(() => NumberConverter.ConvertFractionPartToAnySystem(number, NumberConverter.Decimal));
        }
        #endregion
    }
}
